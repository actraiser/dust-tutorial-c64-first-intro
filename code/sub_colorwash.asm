...
cycle1    ldy color-1,x   ; use y-register to remember color at current position in iteration
...
cycle2    ldy color2,x    ; remember currently pointed at color of second table in y-register
